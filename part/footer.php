          ...
          <div class="row gap-md-0 gap-3">
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-duration="1750">
              ...
              <nav class="list-unstyled">
                <li class="list-space">
                  <p class="list-menu">Nama Yayasan :</br> <span class="fw-bolder text-dark">'.$yayasan['name'].'</span></p>
                </li>
                <li class="list-space">
                  <p class="list-menu">Alamat :</br> <span class="fw-bolder text-dark">'.$yayasan['address'].'</span></p>
                </li>
                <li class="list-space">
                  <p class="list-menu">Kontak :</br> <span class="fw-bolder text-dark">'.$yayasan['phone'].'</span></p>
                </li>
                <li class="list-space">
                  <p class="list-menu">Email :</br> <span class="fw-bolder text-dark">'.$yayasan['email'].'</span></p>
                </li>
              </nav>
            </div>
            <!-- ./col-profil -->
