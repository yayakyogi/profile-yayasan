...
<body>
  ...
  <section class="news mt-3">
    <div class="content">
      <h3 class="mb-4 mt-3 text-center" data-aos="fade-up" data-aos-duration="1000">Profil Yayasan</h3>
      <div class="text-center">
        <img src="public/img/logo.png" class="mb-3 img-fluid" data-aos="fade-up" data-aos-duration="1500"/>
          </br></br></br></br></br>
          <!-- Sejarah Yayasan -->
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <img src="public/img/ilustration-build.png" class="d-sm-block d-none w-75" data-aos="fade-up" data-aos-duration="1500"/>
            </div>
          </div>
          </br></br></br></br></br>
          <!-- Informasi yayasan -->
          <h4 class="mb-3" data-aos="fade-up" data-aos-duration="1000">Informasi Yayasan</h4>
          <div class="row mb-5">
            <div class="col-sm-6">
              <img src="public/img/ilustration-profile.png" class="img-fluid" data-aos="fade-up" data-aos-duration="1250"/>
            </div>
            <div class="col-sm-6 mt-4">
              <div class="table-profile" data-aos="fade-up" data-aos-duration="1500">
